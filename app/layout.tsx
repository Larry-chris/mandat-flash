...
export default function RootLayout({
  ...
  return (
    // 1. ON ENVELOPPE TOUTE L'APP AVEC CLERK
    <ClerkProvider>
      <html lang="fr">
            ...
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-4 gap-8 text-sm">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-slate-400">
                  <li><Link href="/legal/terms" className="hover:text-indigo-400 transition-colors">Conditions Générales</Link></li>
                  <li><Link href="/legal/privacy" className="hover:text-indigo-400 transition-colors">Confidentialité</Link></li>
                  <li><Link href="/legal/refund" className="hover:text-indigo-400 transition-colors">Remboursements</Link></li>
                </ul>
              </div>
